...
# v25.51 黑名单：只删「具体平台/职业操作手册」，不删「营销/商业底层」
# 依据 2026-08-26 用户反馈：营销是泛能力（干啥都需要），营销管理/跨越鸿沟/疯传/上瘾
#   这类讲原理的底层书必须保留；但「抖音/小红书/跨境电商/电商数据」的具体方法=废书，删。
# 删除范畴：
#   ① 具体平台运营（抖音/快手/小红书/视频号/公众号的运营/涨粉/爆款/带货/实操）
#   ② 电商与具体平台操作（淘宝/天猫/京东/拼多多/Shopee/跨境电商/亚马逊 + 电商产品/运营/后台）
...
# ============ 关键词召回规则（v3 实战沉淀） ============
KEY_REMAP = {
    "人性洞察": ["影响力", "乌合之众", "狂热分子", "怪诞行为学", "冲动", "说服", "操纵", "人心", "从众", "人性的弱点"],
